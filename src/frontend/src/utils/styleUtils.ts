...
export const SIDEBAR_CATEGORIES = [
  ...
  { display_name: "向量计算", name: "embeddings", icon: "Binary" },
  { display_name: "智能体", name: "agents", icon: "Bot" },
  { display_name: "Chains", name: "chains", icon: "Link" },
  { display_name: "文档加载器", name: "documentloaders", icon: "Paperclip" },
  { display_name: "Link Extractors", name: "link_extractors", icon: "Link2" },
  { display_name: "记忆", name: "memories", icon: "Cpu" },
  { display_name: "输出解析器", name: "output_parsers", icon: "Compass" },
  { display_name: "Prototypes", name: "prototypes", icon: "FlaskConical" },
  { display_name: "Retrievers", name: "retrievers", icon: "FileSearch" },
  { display_name: "文本拆分器", name: "textsplitters", icon: "Scissors" },
  { display_name: "工具包", name: "toolkits", icon: "Package2" },
  { display_name: "工具", name: "tools", icon: "Hammer" },
  { display_name: "逻辑", name: "logic", icon: "ArrowRightLeft" },
  { display_name: "辅助", name: "helpers", icon: "Wand2" },
];
